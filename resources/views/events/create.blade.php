...
<html lang="pl">
       ...
       <section class="page-section" id="">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Dodaj wydarzenie</h2>
  ...
  @endif
@auth
<form role="form"  action="{{ route('events.store') }}" name="sentMessage" id="comment-form" method="POST" > 
{{csrf_field() }}
  <fieldset>
    <div class="form-group">
    <div class="form-group{{ $errors->has('name')?'has-error':'' }}" id="roles_box">
      <label>Nazwa wydarzenia</label>
      <input type="text" class="form-control" id="name" name="name"  placeholder="Nazwa wydarzenia">
    </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group{{ $errors->has('phone')?'has-error':'' }}" id="roles_box">
      ...
      <input type="tel" class="form-control" id="phone" name="phone" placeholder="XXXXXXXXX" pattern="[0-9]{9}" />
    <div>
    </div>
    <div class="form-group">
    ...
    <button type="submit" id="sendMessageButton" class="btn btn-primary">Zgłoś wydarzenie</button>
  </fieldset>
</form>
@endauth
@guest
    <div class="table-container">
        <b>Zaloguj się aby dodać wydarzenie.</b>
    </div>    
    @endguest 
            </div>
        </section>
